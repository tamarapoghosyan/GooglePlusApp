...
public class Fragment6 extends Fragment {
    public static final String TAG = "GooglePlusApp.Fragment6";
    ...
    public static Fragment6 newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView= (TextView) view.findViewById(R.id.fragment_6_textview);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("Fragment 6 text");
    }
